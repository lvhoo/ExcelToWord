...
public class Kyxm {
	public static Map<String, List<DataVo>> getData(boolean out, String path) throws Exception {
		...
		InputStream kyxmIs = new FileInputStream(path);
		Workbook kyxmRwb = Workbook.getWorkbook(kyxmIs);
		Sheet kyxmRs = (Sheet) kyxmRwb.getSheet(0);
		for (int kyxmRowIndex = 0; kyxmRowIndex < kyxmRs.getRows(); kyxmRowIndex++) {
	...
	public static void main(String[] args) throws Exception {
		Map<String, List<DataVo>> dataMap = Kyxm
				.getData(true, "E:/bnu/2015/2015年科研/2015年省部级项目.xls");
	}
