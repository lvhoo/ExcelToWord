...
public class Kcxx2 {
	...
	public static Map<String, List<DataVo>> getData(boolean out, String path) throws Exception {
		...
		for (int kcxxRowIndex = 0; kcxxRowIndex < kcxxRs.getRows(); kcxxRowIndex++) {
			String daoshiAll = kcxxRs.getCell(2, kcxxRowIndex).getContents().trim();
			String kecheng = kcxxRs.getCell(1, kcxxRowIndex).getContents();
	...
	public static void main(String[] args) throws Exception {
		Map<String, List<DataVo>> dataMap = Kcxx2.getData(true, "E:/bnu/2016/刘烨汇总（给田桦）(1).xls");
	}
