...
public class Xszz {
	...
	public static Map<String, List<DataVo>> getData(boolean out, String path) throws Exception {
		...
		InputStream zzIs = new FileInputStream(path);
		Workbook zzRwb = Workbook.getWorkbook(zzIs);
		Sheet zzRs = (Sheet) zzRwb.getSheet(0);
		for (int zzRowIndex = 0; zzRowIndex < zzRs.getRows(); zzRowIndex++) {
	...
	public static void main(String[] args) throws Exception {
		Map<String, List<DataVo>> dataMap = Xszz.getData(true, "E:/bnu/2015/2015年科研/2015年著作.xls");
	}
