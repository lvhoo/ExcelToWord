...
public class Xxshgz {
	public static Map<String, List<DataVo>> getData(boolean out, String path) throws Exception {
		...
		InputStream xxshgzIs = new FileInputStream(path);
		Workbook xxshgzRwb = Workbook.getWorkbook(xxshgzIs);
		Sheet xxshgzRs = (Sheet) xxshgzRwb.getSheet(0);
		for (int xxshgzRowIndex = 0; xxshgzRowIndex < xxshgzRs.getRows(); xxshgzRowIndex++) {
	...
	public static void main(String[] args) throws Exception {
		Map<String, List<DataVo>> dataMap = Xxshgz.getData(true,
				"E:/bnu/2015/2015社会服务/2015年度考核 担任社会工作情况（整理好）.xls");
	}
