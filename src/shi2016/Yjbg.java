...
public class Yjbg {
	...
	public static Map<String, List<DataVo>> getData(boolean out, String path) throws Exception {
		...
		InputStream yjbgIs = new FileInputStream(path);
		Workbook yjbgRwb = Workbook.getWorkbook(yjbgIs);
		Sheet yjbgRs = (Sheet) yjbgRwb.getSheet(0);
		for (int yjbgRowIndex = 0; yjbgRowIndex < yjbgRs.getRows(); yjbgRowIndex++) {
	...
	public static void main(String[] args) throws Exception {
		Map<String, List<DataVo>> dataMap = Yjbg.getData(true, "E:/bnu/2015/2015年科研/2015年报告.xls");
	}
