...
public class Shi2014ToWordUsingMap {
	...
	InputStream is = new FileInputStream("D:/bnu/people2014.xls");
	...
	InputStream kcxxIs = new FileInputStream("D:/bnu/2014年教学工作量/2014全部授课及实习.xls");
	...
	InputStream dsxsIs = new FileInputStream("D:/bnu/2014年教学工作量/2011-2013年导师带学生数20131106（硕博士）全.xls");
	...
	InputStream shfwIs = new FileInputStream("D:/bnu/2014社会服务/2014其他工作汇总（整理好）.xls");
	...
	InputStream xzzwIs = new FileInputStream("D:/bnu/2014社会服务/2014行政职务（整理好）.xls");
	...
	InputStream xxshgzIs = new FileInputStream("D:/bnu/2014社会服务/2014年度考核 担任社会工作情况（整理好）.xls");
	...
	InputStream xslwIs = new FileInputStream("D:/bnu/2014科研工作量/学术论文.xls");
	...
	InputStream zzIs = new FileInputStream("D:/bnu/2014科研工作量/专著.xls");
	...
	InputStream kyhjIs = new FileInputStream("D:/bnu/2014科研工作量/奖励.xls");
	...
	InputStream yjbgIs = new FileInputStream("D:/bnu/2014科研工作量/咨询报告.xls");
	...
	InputStream kyxmIs = new FileInputStream("D:/bnu/2014科研工作量/2013新立项项目（终）.xls");
	...
	if (peopeInfoList != null && peopeInfoList.size() > 0) {
		...
		String fileName = "D:/bnu/2014/教师考核表_" + userId + "_" + userName + ".doc";
