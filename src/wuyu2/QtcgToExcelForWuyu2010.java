...
public class QtcgToExcelForWuyu2010 {

	public static void main(String[] args) throws Exception {
		System.out.println("====================================其他成果Excel整理begin================================================");

		System.out.println("========================获取文件夹中的文件begin============");
		String dirPath = "E:/wuyu2/其他成果";
		...
		String path = "E:\\wuyu2\\其他成果2010.xls";
		book = Workbook.createWorkbook(new File(path));
		sheet = book.createSheet("其他成果", 0);
		int rowIndex = 1;
		...
		for (int filePathIndex = 0; filePathIndex < filePathList.size(); filePathIndex++) {
			...
			// columnNum = 33; //其他成果中的特定值

			Cell cell = null;
			String contentTemp = "";
			for (int i = 6; i <= rowNum - 1; i++) {
				if(rs.getCell(21, i).getContents().trim().equals("2010") || rs.getCell(21, i).getContents().trim().equals("2010年") || (rs.getCell(21, i).getContents().length()>=4 && rs.getCell(21, i).getContents().substring(0,3).equals("2010"))) {
