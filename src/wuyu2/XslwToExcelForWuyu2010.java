...
public class XslwToExcelForWuyu2010 {
	
	public static void main(String[] args) throws Exception {
		System.out.println("====================================学术论文Excel整理begin================================================");
		
		System.out.println("========================获取文件夹中的文件begin============");
		String dirPath = "E:/wuyu2/学术论文";
		...
		String path = "E:\\wuyu2\\学术论文2010.xls";
		...
		for (int filePathIndex=0; filePathIndex<filePathList.size(); filePathIndex++) {
			...
			InputStream is = new FileInputStream(filePath2); // File is = new File("D:/test2010.xls");
			...
			for (int i = 6; i <= rowNum-1; i++) {
				if(rs.getCell(19, i).getContents().trim().equals("2010") || rs.getCell(19, i).getContents().trim().equals("2010年") || (rs.getCell(19, i).getContents().length()>=4 && rs.getCell(19, i).getContents().substring(0,3).equals("2010"))) {
