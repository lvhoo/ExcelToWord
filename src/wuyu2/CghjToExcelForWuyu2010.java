...
public class CghjToExcelForWuyu2010 {

	public static void main(String[] args) throws Exception {
		System.out.println("====================================成果获奖Excel整理begin================================================");

		System.out.println("========================获取文件夹中的文件begin============");
		String dirPath = "E:/wuyu2/成果获奖";
		...
		String path = "E:\\wuyu2\\成果获奖2010.xls";
		book = Workbook.createWorkbook(new File(path));
		sheet = book.createSheet("成果获奖", 0);
		int rowIndex = 1;
		...
		for (int filePathIndex = 0; filePathIndex < filePathList.size(); filePathIndex++) {
			...
			InputStream is = new FileInputStream(filePath2); 
			...
			// columnNum = 32; //成果获奖中的特定值

			Cell cell = null;
			String contentTemp = "";
			for (int i = 6; i <= rowNum - 1; i++) {
				if(rs.getCell(20, i).getContents().trim().equals("2010") || rs.getCell(20, i).getContents().trim().equals("2010年") || (rs.getCell(20, i).getContents().length()>=4 && rs.getCell(20, i).getContents().substring(0,3).equals("2010"))) {
